...
class LayoutManager: NSLayoutManager {
    ...
    ///
    var blockquoteBorderColor = UIColor(red: 177.0/255.0, green: 183.0/255.0, blue: 205.0/255.0, alpha: 1.0)

    /// Blockquote's Background Color
    ///
    var blockquoteBackgroundColor = UIColor(red: 250.0/255.0, green: 250.0/255.0, blue: 252.0/255.0, alpha: 1.0)
